...
public class AdvertisementMain implements Commands {
    ...
    private static void registerUser() {
        System.out.println("Please input user data name,surname,gender(MALE,FEMALE)," +
    ...
    private static void addNewItem() {
        ...
        try {
            ...
            Item item = new Item(itemDataArr[0], itemDataArr[1], Double.parseDouble(itemDataArr[2]), currentUser, Category.valueOf(itemDataArr[3].toUpperCase()), new Date());
