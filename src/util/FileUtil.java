...
public class FileUtil {
    private static final String USER_MAP_PATH = "D:\\java daser\\Advertisment\\src\\resource\\userMap.obj";
    private static final String ITEM_LIST_PATH = "D:\\java daser\\Advertisment\\src\\resource\\itemList.obj";
    ...
    public static void serializeUserMap(Map<String, User> userMap) {
        ...
        try {
            ...
            // try s resursami or kgren pakagci mej el objectOutputStream.close(); petq che enel hakarak depqum pti
            //anpayman close enel
